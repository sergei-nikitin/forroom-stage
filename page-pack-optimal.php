<?php
/*
Template Name: Пакет Оптимальный(new)
          ...
          <div class="header__body">
            <div class="header__body-wrap">
              ...
              <p class="header__text">
               Оптимальный пакет ремонта включающий все самое необходимое для комфортной жизни
              </p>
              <p class="header__price">390 $/кв.м</p>
              <div class="header__btn">
                <button type="button" class="btn btn_big-fill" data-stili-item="пакет Оптимальный" data-open-popup="call-popup"
                  >заказать</button
                >
              </div>
            </div>
    ...
    <div class="payment__cart anim-item">
      ...
      <section class="gift gift_reverse">
        <div class="gift__content">
          ...
          <div class="gift__btn">
             <button type="button" data-stili-item="пакет Оптимальный" data-open-popup="call-popup" class="btn btn_big-fill">заказать пакет</button>
          </div>
        </div>
