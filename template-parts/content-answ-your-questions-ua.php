		...
		<section class="doubt">
			<div class="doubt__content">
				<div class="doubt__title">
					<h2>ВІДПОВІМО НА ПИТАННЯ</h2>
					<h3>КОНТАКТИ</h3>
				</div>
				<p class="doubt__text">Приходьте на екскурсію до шоуруму або проконсультуйтеся з нашим експертом. Ми знаємо, як зробити ремонт приємною турботою без стресів.</p>
           ...
           <input type="hidden" name="action" value="answer_your_questions">
            <input type="hidden" name="title" value="Форма главная подвал + о нас (ответим на вопросы) - UA">
						...
						<div class="doubt__form-btn">
							<button type="submit" class="btn btn_big-fill">ЗВОРОТНИЙ ЗВ'ЯЗОК</button>
							<!-- <button type="submit" class="btn btn_big-fill" onclick="window.dataLayer = window.dataLayer || []; window.dataLayer.push({'event': 'form-main'})">ЗВОРОТНИЙ ЗВ'ЯЗОК</button> -->
						</div>
					</form>
					...
					<div class="doubt__info">
						<p class="doubt__info-text">ТРЦ «МЕГАДІМ» </p>
						<address class="doubt__info-address">вул. Толбухіна 135</address>
