<?php
/*
Template Name: Шаблон открытого Портфолио UA
...
if( has_tag( 'remont' ) ) 
   ...
   echo get_template_part( 'template-parts/content', 'slide-packages-ua' ); 
    
?>
                    <?php
if( has_tag( 'design' ) )
	 echo get_template_part( 'template-parts/content', 'slide-design-ua' ); 
?>
<?php get_footer('ua'); ?>