...
<?php get_header(); ?>
    ...
    <?php echo get_template_part( 'template-parts/content', 'popaps' ); ?>
          ...
          <div class="header__body">
            <div class="header__body-wrap">
              ...
              <p class="header__text">
               WhiteBox - это вся предчистовая отделка под ключ
              </p>
              <p class="header__price">150 $/кв.м</p>
              <div class="header__btn">
                <button type="button" class="btn btn_big-fill" data-stili-item="пакет White Box" data-open-popup="call-popup"
                  >заказать</button
                >
              </div>
            </div>
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide ib">
                  <img src="<?php echo get_template_directory_uri() ?>/source/new-img/page-package/box-bg.jpg" alt="1" class="ib_use" />
                </div>
              </div>
            </div>
          </div>
     ...
     <!-- Table -->
      ...
      <section class="table-package" data-active-column="1">
    ...
    <div class="payment__cart anim-item">
      ...
      <section class="gift gift_reverse">
        <div class="gift__content">
          ...
          <div class="gift__btn">
              <button type="button" data-stili-item="пакет White Box" data-open-popup="call-popup" class="btn btn_big-fill">заказать пакет</button>
          </div>
        </div>
