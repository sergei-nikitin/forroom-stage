<?php
/*
Template Name: Шаблон открытого Портфолио
...
if( has_tag( 'remont' ) ) 
   ...
   echo get_template_part( 'template-parts/content', 'slide-packages' ); 
    
?>
                    <?php
if( has_tag( 'design' ) )
	 echo get_template_part( 'template-parts/content', 'slide-design' ); 
?>
<?php get_footer(); ?>