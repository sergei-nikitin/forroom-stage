			...
			<div class="contacts__content">
				...
				<div class="block-tabs contacts__tabs">
					<div class="block-tabs__btns contacts__tabs-btns">
						<div class="block-tabs__btn contacts__tabs-btn" data-city-item="Одесса">ОДЕСА</div>
						<div class="block-tabs__btn contacts__tabs-btn" data-city-item="Львов">ЛЬВІВ</div>
						<!-- <div class="block-tabs__btn contacts__tabs-btn" data-city-item="Киев">КИЇВ</div> -->
					</div>
							...
							<div class="contacts__tab-wrap">
								<ul class="contacts__tab-list">
									...
									<li>
										...
										<p>ТРЦ «МЕГАДІМ», вул.Толбухіна 135</p> 
									</li>
									<li>
						...
						<div class="block-tabs__tab contacts__tab">
							<div class="contacts__tab-wrap">
								<ul class="contacts__tab-list">
									...
									<li>
										<span class="iconify" data-icon="la:map-marker-alt"></span>
										<p>Львів, вул. Професора Буйка, 27</p>
									</li>
									<li>
										<span class="iconify" data-icon="la:clock-solid"></span>
										<p>Пн-Пт 10:00 – 20:00</p> 
				...
				<div class="contacts__btn">
					<div id="btn-contacts" data-disable-test-popup data-open-popup="call-popup" class="btn btn_big-fill">ЗВОРОТНИЙ ЗВ'ЯЗОК </div>
				</div>
			</div>
