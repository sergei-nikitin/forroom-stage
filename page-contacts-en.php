			...
			<div class="contacts__content">
				...
				<div class="block-tabs contacts__tabs">
					<div class="block-tabs__btns contacts__tabs-btns">
						<div class="block-tabs__btn contacts__tabs-btn" data-city-item="Одесса">Odessa</div>
						<div class="block-tabs__btn contacts__tabs-btn" data-city-item="Львов">Lviv</div>
						<!-- <div class="block-tabs__btn contacts__tabs-btn" data-city-item="Киев">Kyiv</div> -->
					</div>
							...
							<div class="contacts__tab-wrap">
								<ul class="contacts__tab-list">
									...
									<li>
										...
										<p>"MEGADOM" shopping mall, 135 Tolbukhina St.</p> 
									</li>
									<li>
						...
						<div class="block-tabs__tab contacts__tab">
							<div class="contacts__tab-wrap">
								<ul class="contacts__tab-list">
									...
									<li>
										<span class="iconify" data-icon="la:map-marker-alt"></span>
										<p>Lviv, st. Professor Buiko, 27</p>
									</li>
									<li>
										<span class="iconify" data-icon="la:clock-solid"></span>
										<p>Mon. - Fri. 10am – 10pm</p> 
				...
				<div class="contacts__btn">
					<div id="btn-contacts" data-disable-test-popup data-open-popup="call-popup" class="btn btn_big-fill">Contact me</div>
				</div>
			</div>
