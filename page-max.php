<?php
/*
Template Name: Пакет Максимальный(new)
        ...
        <div class="header__inner nav-add-padding">
          <div class="header__body">
            <div class="header__body-wrap">
              ...
              Пакет ремонта для тех, кому нужен максимальный комфорт и функционал в квартире
              </p>
              <p class="header__price">490 $/кв.м</p>
              <div class="header__btn">
                <button type="button" class="btn btn_big-fill" data-stili-item="пакет Максимальный" data-open-popup="call-popup"
                  >заказать</button
                >
              </div>
            </div>
...
<div class="package__inner">
          ...
          <div class="package__list">
            ...
            <h4 class="package__list-title">Материалы</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Корпуса - ДСП Egger (Австрия)</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Фасады и столешница - ДСП Egger </span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Задняя стенка - ДВП KRONO 3мм</span
                    >
                  </li>
                  <li>
                    <span
                  ...
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Выдвижные механизмы с доводчиками - Tandem</span
                    >
                  </li>
                 
                </ul>
            <h4 class="package__list-title">Наполнение кухни</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Каменная мойка - Galati</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Фильтр для воды - Eco Soft</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Смеситель - Imprese</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Лоток для столовых приборов</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Сушка для посуды</span
                    >
                  </li>
                </ul>
          </div>
...
<div class="package__inner">
          ...
          <div class="package__list">
            ...
            <h4 class="package__list-title">Кондиционер</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Бренды: GREE, Neoclima, Cooper Hunter, Leberg</span
                    >
                  </li> </ul>
            <h4 class="package__list-title">Бойлер</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Бренды: Tesy, Atlantic, GORENJE, BOSCH, ZANUSSI </span
                    >
                  </li>
                </ul>
          </div>
            ...
            <div class="package__content-title">
              <h2>АКСЕССУАРЫ</h2>
              <h3>АКСЕССУАРЫ ДЛЯ САНУЗЛА</h3>
            </div>
            <h4 class="package__list-title">Электрический полотенцесушитель</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Бренд: Mario (Украина)</span
                    >
                  </li> </ul>
            <h4 class="package__list-title">Зеркало с LED-подсветкой</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Бельгийское зеркало под заказ с подсветкой по периметру</span
                    >
                  </li>
                </ul>
          </div>
...
<div class="package__inner">
          ...
          <div class="package__list">
            ...
            <h4 class="package__list-title">ШТОРЫ</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Декатировка штор</span
                    >
                  </li>
                  <li>
                    <span
                  ...
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Установка декоративных подхватов</span>
                  </li>
                </ul>
            <h4 class="package__list-title">Материалы</h4>
                <ul class="package__list-list">
...
<div class="package__inner">
          ...
          <div class="package__list">
            <div class="package__content-title">
              <h2>СПАЛЬНЯ</h2>
              <h3>СПАЛЬНЫЙ ГАРНИТУР</h3>
            </div>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Двуспальная кровать</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Две тумбы + комод</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Шкаф с распашными дверями</span
                    >
                  </li>
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span
                      >Все наборы спальных гирнитур выдержаны в едином стиле.</span
                    >
                  </li>
...
<div class="package__inner">
          ...
          <div class="package__list">
            ...
            <h4 class="package__list-title">Телевизор</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span>
                      Бренды: Philips, Samsung, Toshiba, LG, Panasonic, Sharp, Kivi</span>
                  </li>
                </ul>
            ...
            <h4 class="package__list-title">Варочная поверхность</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span>
            ...
            <h4 class="package__list-title">Вытяжка</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span>
            ...
            <h4 class="package__list-title">Духовой шкаф</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span>
            ...
            <h4 class="package__list-title">Стиральная машина</h4>
                <ul class="package__list-list">
                  <li>
                    <span
                      ><span class="iconify" data-icon="la:check-double"></span>
    ...
    <div class="payment__cart anim-item">
      ...
      <section class="gift gift_reverse">
        <div class="gift__content">
          ...
          <div class="gift__btn">
            <button type="button" data-stili-item="пакет Максимальный" data-open-popup="call-popup" class="btn btn_big-fill">заказать пакет</button>
          </div>
        </div>
